...
use App\Models\Model_riwayat_test;

class RiwayatTest extends BaseController
{

    protected $Model_riwayat_test;
    ...
    public function index()
    {
        ...
        return view('Admin/viewTTestRiwayat', $data);
    }
    ...
    public function add_test()
    {
        ...
        return redirect()->to(base_url('Admin/RiwayatTest'));
    }
    ...
    public function update_test()
    {
        ...
        return redirect()->to(base_url('Admin/RiwayatTest/detail_test' . '/' . $idjadwal));
    }
    ...
    public function delete_test()
    {
        ...
        return redirect()->to('/Admin/RiwayatTest');
    }
    ...
    public function detail_test($id)
    {
        ...
        return view('Admin/viewTTestDetailRiwayat', $data);
    }    
