...
<html class="no-js css-menubar" lang="en">
    <head>
        ...
        <title>Pendaftaran Toefl UNIPMA</title>
        ...
        <div class="page">
            <div class="page-content container-fluid">
                    ...
                    <div class="card card-shadow" id="widgetLineareaOne">
                        <div class="card-block p-20 pt-10">
                            ...
                            <div class="grey-800 float-left py-10">
                                <i class="icon md-account-circle grey-600 font-size-24 vertical-align-bottom mr-5"></i> Master Periode
                            </div>
                            </div>
                            ...
                            <div class="mb-20 grey-500">
                                <a href="<?= base_url('Admin/Periode'); ?>">Lihat Detail Data</i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-shadow" id="widgetLineareaTwo">
                        <div class="card-block p-20 pt-10">
                            <div class="clearfix">
                            <div class="grey-800 float-left py-10">
                                <i class="icon md-flash grey-600 font-size-24 vertical-align-bottom mr-5"></i> Master Pendaftar
                            </div>
                            </div>
                            <div class="float-right grey-700 font-size-30">
                            <?= $pendaftar ?>
                            ...
                            <br><br>
                            <div class="mb-20 grey-500">
                                <a href="<?= base_url('Admin/Pendaftar'); ?>">Lihat Detail Data</i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-shadow" id="widgetLineareaThree">
                        <div class="card-block p-20 pt-10">
                            <div class="clearfix">
                            <div class="grey-800 float-left py-10">
                                <i class="icon md-account grey-600 font-size-24 vertical-align-bottom mr-5"></i> Master Jadwal
                            </div>
                            </div>
                            <div class="float-right grey-700 font-size-30">
                            <?= $jadwal ?>
                            ...
                            <br><br>
                            <div class="mb-20 grey-500">
                                <a href="<?= base_url('Admin/Jadwal'); ?>">Lihat Detail Data</i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-md-6">
                    ...
                    <div class="card card-shadow" id="widgetLineareaFour">
                        <div class="card-block p-20 pt-10">
                            <div class="clearfix">
                                <div class="grey-800 float-left py-10">
                                    <i class="icon md-view-list grey-600 font-size-24 vertical-align-bottom mr-5"></i> Master Jenis
                                </div>
                            </div>
                            <div class="float-right grey-700 font-size-30">
                                <?= $jenis ?>
                            ...
                            <br><br>
                            <div class="mb-20 grey-500">
                                <a href="<?= base_url('Admin/Jenis'); ?>">Lihat Detail Data</i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxl-12 col-lg-12">
                    ...
                    <br>
                    <h3>
                        Selamat Datang di Pendaftaran Toefl<br>
